...
jest.mock(
  ...
  () => ({
    TourInclude: () => (
      <div data-testid="tour-include">Include Mock</div>
    ),
  })
)
jest.mock(
  '../src/modules/DetailTourModule/module-elements/TourList',
  () => ({
    TourList: () => (
      <div data-testid="tour-list">List Mock</div>
    ),
  })
)
jest.mock(
...
jest.mock(
  '../src/modules/DetailTourModule/module-elements/TourHeader',
  () => ({
    TourHeader: () => (
      <div data-testid="tour-header">Header Mock</div>
    ),
  })
)
