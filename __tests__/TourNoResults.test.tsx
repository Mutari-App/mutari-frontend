...
import NoResults from '@/modules/TourSearchResultsModule/module-elements/NoResults'
...
describe('NoResults Component', () => {
  ...
  test('renders correctly with a search query', () => {
    ...
    const message = screen.getByText(
      /Kami tidak dapat menemukan tur yang cocok dengan "Lombok"/
    )
