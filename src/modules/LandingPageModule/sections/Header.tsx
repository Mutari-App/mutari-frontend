...
export const Header: React.FC = () => {
  return (
    <header className='max-h-screen overflow-hidden relative'>
      ...
      />
      <div className='w-full absolute bg-black/30 min-h-screen top-0 left-0 z-20 flex justify-center items-center text-white
      flex-col gap-5'>
        ...
        <Link href={'/#about'} className='flex font-semibold animate-bounce call-to-action'>
        <ChevronsDownIcon />
