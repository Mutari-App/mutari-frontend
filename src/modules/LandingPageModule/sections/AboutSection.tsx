...
export const AboutSection: React.FC = () => {
  return (
    <section className="w-full sm:mb-8 md:mb-14 lg:mb-24 xl:mb-32 flex justify-center items-center py-10 sm:pb-20 overflow-hidden">
      <div
        className="box-content  max-w-screen-lg relative w-4/5 h-auto min-h-72 px-4 py-2 flex-col md:flex-row xl:py-12 mx-auto bg-white shadow-md  border rounded-md border-gray-300 flex md:justify-evenly items-center gap-3"
      ...
      >
        ...
        <div className="w-full md:w-3/5 text-center  mb-6 md:mb-0 -mt-10 md:mt-0 md:mr-6  flex flex-col items-center justify-center relative">
          <h2 className="text-lg sm:text-3xl font-bold text-blue-600">
            ABOUT US
          </h2>
