...
export const CreateItinerarySection: React.FC = () => {
  return (
    <section className="container mx-auto px-2 flex text-center flex-col items-center">
      <h2 className="text-lg text-[#3C3744]  md:text-4xl font-semibold text-center pb-2">
        Buat Itinerary
      </h2>
      <p className="font-light pb-6 text-lg">
      ...
      <div className="w-full relative max-w-screen-lg ">
        ...
        <div className="relative w-full h-full overflow-hidden border-[3px]  border-[#bdd5ec] rounded-2xl bg-white/20 backdrop-blur-sm drop-shadow-[0_0px_10px_rgba(0,0,0,0.25)]">
          <div className="absolute bg-gradient-to-br from-[#ADD4FC] via-[#0E7DED] to-[#ADD4FC]  w-full h-full opacity-30" />
          <div className="w-full h-full px-8 pb-16 pt-4 flex flex-col gap-4">
            <div className="flex gap-2 relative">
              <div className="w-4 h-4 rounded-full bg-red-500" />
              <div className="w-4 h-4 rounded-full bg-yellow-500" />
              <div className="w-4 h-4 rounded-full bg-green-500" />
            </div>
            <div className="relative aspect-[3/2] w-full h-full overflow-hidden rounded-2xl">
              <Image
